 ...
 */
final class Version20220422124755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trajet (id INT AUTO_INCREMENT NOT NULL, ville_dep_id INT DEFAULT NULL, ville_arrs_id INT DEFAULT NULL, pers_id INT DEFAULT NULL, nb_kms INT NOT NULL, datatrajet DATETIME NOT NULL, UNIQUE INDEX UNIQ_2B5BA98C97A9E2C6 (ville_dep_id), UNIQUE INDEX UNIQ_2B5BA98CA3CA3DA6 (ville_arrs_id), UNIQUE INDEX UNIQ_2B5BA98C4AA53143 (pers_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE trajet ADD CONSTRAINT FK_2B5BA98C97A9E2C6 FOREIGN KEY (ville_dep_id) REFERENCES ville (id)');
        $this->addSql('ALTER TABLE trajet ADD CONSTRAINT FK_2B5BA98CA3CA3DA6 FOREIGN KEY (ville_arrs_id) REFERENCES ville (id)');
